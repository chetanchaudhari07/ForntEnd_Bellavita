...
<footer className='' style={{backgroundColor:'grey'}}>
    ...
    <div className="lg:flex lg:items-start lg:gap-8">
      ...
      <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
        ...
        <div className="col-span-2 sm:col-span-1">
          <p className="font-medium text-gray-900">BESTSELLER</p>

          <ul className="mt-6 space-y-4 text-sm">
            <li>
              <a href="#" className="text-gray-700 transition hover:opacity-75"> Ultimate Perfume Box </a>
            </li>

            <li>
              <a href="#" className="text-gray-700 transition hover:opacity-75"> Perfume Gift Set For Men</a>
            </li>

            <li>
              <a href="#" className="text-gray-700 transition hover:opacity-75"> Perfume Gift Set For Women</a>
            </li>

            <li>
              <a href="#" className="text-gray-700 transition hover:opacity-75">Under Eye Cream for </a>
            </li>

            <li>
              <a href="#" className="text-gray-700 transition hover:opacity-75"> Dark Circles </a>
            </li>

            <li>
              <a href="#" className="text-gray-700 transition hover:opacity-75"> Unisex Perfume </a>
            </li>
          </ul>
        </div>
        ...
        <div className="col-span-2 sm:col-span-1">
          ...
          <ul className="mt-6 space-y-4 text-sm">
            ...
            <li>
              <a href="#" className="text-gray-700 transition hover:opacity-75"> Tearm & Conditions </a>
            </li>
            ...
            <li>
              <a href="#" className="text-gray-700 transition hover:opacity-75"> Refund & Return </a>
            </li>
